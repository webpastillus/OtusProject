...
#### Clients - Хранит основную информацию о клиентах компании
...
#### ContactInfoType - Таблица с типами контактной информации клиентов
...
#### ClientContactInfo - Хранит контактную информацию о клиенте
...
#### UserRoles - Таблица с ролью/должностью сотрудников в CRM
...
#### Users - Хранит информацию о сотрудниках
...
#### DealStatuses - Хранит информацию о сотрудниках
...
#### Deals - Хранит информацию по заявокам клиентов
...
#### DealsHistory - Хранит информацию об истории изменения статуса заявки
...
#### InteractionTypes - Таблица с типами взаимодействия с клиентами
...
#### Interactions - Хранит информацию об истории взаимодействия с клиентами
...
#### Products - Таблица с продуктами/услугами и их ценой
...
#### DealProducts - Хранит информацию о продуктах в заказах клиента
...
#### Payments - Хранит информацию о продуктах в заказах клиента
